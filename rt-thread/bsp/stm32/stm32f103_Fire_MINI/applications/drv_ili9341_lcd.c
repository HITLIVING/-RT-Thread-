...
static void ILI9341_Pin_Config ( void )
{
	...
	rt_pin_mode(ILI9341_D4, PIN_MODE_OUTPUT);
	rt_pin_mode(ILI9341_D5, PIN_MODE_OUTPUT);
	rt_pin_mode(ILI9341_D6, PIN_MODE_OUTPUT);
	rt_pin_mode(ILI9341_D7, PIN_MODE_OUTPUT);
	rt_pin_mode(ILI9341_D8, PIN_MODE_OUTPUT);
	rt_pin_mode(ILI9341_D9, PIN_MODE_OUTPUT);
	rt_pin_mode(ILI9341_D10, PIN_MODE_OUTPUT);
	rt_pin_mode(ILI9341_D11, PIN_MODE_OUTPUT);
	rt_pin_mode(ILI9341_D12, PIN_MODE_OUTPUT);
	rt_pin_mode(ILI9341_D13, PIN_MODE_OUTPUT);
	rt_pin_mode(ILI9341_D14, PIN_MODE_OUTPUT);
