...
rt_uint8_t MPU_WaitForReady(rt_uint8_t devaddr);
rt_uint8_t MPU_Write_Byte(rt_uint8_t devaddr,rt_uint8_t reg,rt_uint8_t data);
rt_uint8_t MPU_Read_Byte(rt_uint8_t devaddr,rt_uint8_t reg);
...
rt_uint8_t MPU_Write_Len(rt_uint8_t addr,rt_uint8_t reg,rt_uint8_t len,rt_uint8_t *buf);
